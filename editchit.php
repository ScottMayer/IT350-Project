...
<div class="form-check">
  ...
  <div class="row" style="border-left: 1px solid #000000; border-right:1px solid #000000; border-bottom:1px solid #000000;">
    ...
    <div class="col-sm-5">
      <input required type="text" name="ADDRESS_CITY" class="form-control-sm" placeholder="" size="20" value="<?php if(isset($_POST['ADDRESS_CITY'])){echo "{$_POST['ADDRESS_CITY']}";}?>">
      <input required type="text" name="ADDRESS_STATE" class="form-control-sm" placeholder="XX" size="2" maxlength="2" value="<?php if(isset($_POST['ADDRESS_STATE'])){echo "{$_POST['ADDRESS_STATE']}";}?>">
      <input required type="text" name="ADDRESS_ZIP" class="form-control-sm" placeholder="XXXXX" size="5" maxlength="5" value="<?php if(isset($_POST['ADDRESS_ZIP'])){echo "{$_POST['ADDRESS_ZIP']}";}?>">
      <input required type="text" name="PHONE" class="form-control-sm" placeholder="(XXX) XXX-XXXX" size="14" maxlength="14" value="<?php if(isset($_POST['PHONE'])){echo "{$_POST['PHONE']}";}?>">
    </div>
  </div>
  <div class="row" style="border-left: 1px solid #000000; border-right:1px solid #000000;">
    <div class="col-md-12">
